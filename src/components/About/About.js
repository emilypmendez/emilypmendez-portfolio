...
import developer from "../../Assets/emilypmendez-circle.png";
        ...
        <Row style={{ justifyContent: "center", padding: "10px" }}>
          ...
          >
            <h1 style={{ fontSize: "2.1em", paddingBottom: "20px" }}>
              <strong className="blue">Integrity. Innovation. Impact.</strong>
            </h1>
            <Aboutcard />
          </Col>
        ...
        <Row className="skill-tools-wrapper">
          <Col className="skill-wrapper">
            <h1 className="project-heading">
              <strong className="blue">My Skills </strong>
            </h1>
          ...
          <Col className="skill-wrapper">
            <h1 className="project-heading">
              <strong className="blue">My Tools</strong>
            </h1>
